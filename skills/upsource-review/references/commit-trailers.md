...
# them in `.lifeline-upsource-review/replies-failed-human-issue.txt`; here we
...
REPLIES_FAILED_FILE=".lifeline-upsource-review/replies-failed-human-issue.txt"
...
```bash
COMMIT_MSG_FILE=".lifeline-upsource-review/cycle-${ROUND}-commit-msg.txt"
...
while IFS= read -r finding; do
  ...
  # `.lifeline-upsource-review/replies-failed-human-issue.txt` (gitignored)
...
- Lives at `.lifeline-upsource-review/replies-failed-human-issue.txt` (one
  COMMENT_ID per line, blank lines stripped). Gitignored alongside the
  rest of `.lifeline-upsource-review/`.
