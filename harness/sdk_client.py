...
def create_client(
    ...
    system_prompt = (
        f"[Harness role: {role}]\n\n"
        "You are an expert software engineer working in the project rooted at "
        "the current working directory. Read and follow any CLAUDE.md, "
        "AGENTS.md, rules/, or docs/ specifications you find there. "
        "Use immutable patterns where natural, explicit error handling, and "
        "write tests first."
    )
